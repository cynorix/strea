...
$jsonUrl = "https://streamed.pk/api/matches/all";
$defaultPoster = 'https://streamed.pk/api/images/poster/fallback.webp';
...
foreach ($data as $match) {
    ...
    $poster = isset($match['poster']) ? 'https://streamed.pk' . $match['poster'] : $defaultPoster;
...
echo "M3U file has been saved as streamed.m3u8.\n";
